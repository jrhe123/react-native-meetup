...
export const createGroup = async(req, res) => {
  ...
  try {
    ...
    return res.status(400).json({
      error: true,
      message: 'Error when created group'
    })
  }
...
// create meetup and insert to group
export const createGroupMeetup = async(req, res) => {
  ...
  try {
    ...
    return res.status(400).json({
      error: true,
      message: 'Error when created group meetups'
    })
  }

}

// get meetups by groupId
export const getGroupMeetups = async(req, res) => {
  ...
  try {
    ...
    return res.status(400).json({
      error: true,
      message: 'Error fetch group meetups'
    })
  }
